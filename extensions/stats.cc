...
template class Stats< Flooding >;
typedef Stats< Flooding > StatsFlooding;
NS_OBJECT_ENSURE_REGISTERED(StatsFlooding);

template class Stats< SmartFlooding >;
typedef Stats< SmartFlooding > StatsSmartFlooding;
NS_OBJECT_ENSURE_REGISTERED(StatsSmartFlooding);
